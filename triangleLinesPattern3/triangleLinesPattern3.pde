...
void draw() {
  ...
  PVector m = new PVector(width/2, height-padding);
  PVector m2 = new PVector(width/2, 0);
  ...
  stroke(#B24E40,222);
  strokeCap(PROJECT);
  drawTriangleLines(m, a, b);
  drawTriangleLines(a, c, m);
  drawTriangleLines(b, m, d);
  
  //drawTriangleLines(a, c, center);
  //drawTriangleLines(b, d, center);
  //drawTriangleLines(c, a, center);
  //drawTriangleLines(d, center, b);
